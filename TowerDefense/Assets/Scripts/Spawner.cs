...
public class Spawner : MonoBehaviour
{
    ...
    private void InitWaves() {
        ...
        /// bomb, mud,  zombie
        Globals.waves = new Queue<Wave>();
        Wave wave1 = new Wave(0.0f, 300.0f);
        ...
        wave2.AddEnemy(Globals.EnemyType.Standard, false, true, false, 0.5f);
        ...
        wave3.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave3.AddEnemy(Globals.EnemyType.Standard, false, false, false, 0.5f);
        wave3.AddEnemy(Globals.EnemyType.Jumper, false, false, false, 0.5f);
        wave3.AddEnemy(Globals.EnemyType.Jumper, false, false, false, 0.5f);
        wave3.AddEnemy(Globals.EnemyType.Jumper, false, false, false, 0.5f);
        wave3.AddEnemy(Globals.EnemyType.Jumper, false, false, false, 0.5f);
        wave3.AddEnemy(Globals.EnemyType.Jumper, false, false, false, 0.5f);
        ...
        wave4.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave4.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave4.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave4.AddEnemy(Globals.EnemyType.Standard, false, true, false, 0.5f);
        wave4.AddEnemy(Globals.EnemyType.Standard, false, true, false, 0.5f);
        wave4.AddEnemy(Globals.EnemyType.Standard, false, true, false, 0.5f);
        ...
        wave5.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave5.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave5.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave5.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave5.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        ...
        wave6.AddEnemy(Globals.EnemyType.Heavy, true, true, true, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Heavy, true, true, true, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Jumper, true, false, false, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Jumper, true, false, false, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Jumper, true, false, false, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Standard, true, false, true, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Standard, true, false, true, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Standard, true, false, true, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
        wave6.AddEnemy(Globals.EnemyType.Standard, true, false, false, 0.5f);
